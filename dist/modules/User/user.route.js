...
router.get('/', (0, auth_1.auth)('admin', 'user'), user_controller_1.getAllUsers);
router.post('/', (0, validateRequest_1.default)(user_validation_1.createUserValidationSchema), user_controller_1.createUser);
router.patch('/:id', (0, auth_1.auth)('admin', 'user'), multer_config_1.multerUpload.single('image'), (req, res, next) => {
    req.body = JSON.parse(req.body.data);
    next();
}, user_controller_1.updateUser);
router.patch('/change-status/:id', (0, auth_1.auth)('admin', 'user'), user_controller_1.updateStatus);
router.patch('/change-role/:id', (0, auth_1.auth)('admin', 'user'), user_controller_1.updateRole);
router.get('/:id', (0, auth_1.auth)('admin', 'user'), user_controller_1.getSingleUser);
